...
const URL = {
  ...
  //   if (isProduction) return `https://github.com/login/oauth/access_token?client_id=${process.env.PRODUCTION_CLIENT_ID}&client_secret=${process.env.PRODUCTION_CLIENT_SECRET}&code=${requestToken}`;
  //   return `https://github.com/login/oauth/access_token?client_id=${process.env.LOCAL_CLIENT_ID}&client_secret=${process.env.LOCAL_CLIENT_SECRET}&code=${requestToken}`;
  // },
